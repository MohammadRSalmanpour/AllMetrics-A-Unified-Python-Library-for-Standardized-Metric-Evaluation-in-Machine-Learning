# -*- coding: utf-8 -*-
"""Github_V15_i2i_codes.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PXxanpG6z4nN5LBXXPK9_Mgujn3vxATT
...
def psnr(
    image_true: Union[np.ndarray, list, torch.Tensor],
    image_test: Union[np.ndarray, list, torch.Tensor],
...
def ssim(
    img1: Union[np.ndarray, list],
    img2: Union[np.ndarray, list],
    window_size: int = 11,
    ...
    if validator is not None:
        img1, img2 = validator.validate_all(img1, img2, auto_scale=auto_scale, check_channels=multichannel)

    # If validator is None, transfer datatype
    else:
    ...
    if img1.shape != img2.shape:
        raise ValueError(f"Shape mismatch after validation: {img1.shape} vs {img2.shape}")
